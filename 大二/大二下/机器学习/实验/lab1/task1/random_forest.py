...
def wine():
    ...
    print(f"Random Forest Classifier Precision: {precision:.6f}")
    print(f"Random Forest Classifier Recall: {recall:.6f}")

    # Ameliorate the model using GridSearchCV
    ...
    print(f"Original parameters: criterion: {classifier.get_params()['criterion']}, "
          ...
          f"n_estimators: {classifier.get_params()['n_estimators']}")
...
def diabetes():
    ...
    print(f"Random Forest Regressor MedAE: {medae:.2f}")
    ...
    print(f"Original parameters: criterion: {regressor.get_params()['criterion']}, "
          ...
          f"n_estimators: {regressor.get_params()['n_estimators']}")
    print(f"Best parameters: {grid_search.best_params_}")
    print(f"Random Forest Regressor MSE: {mse:.2f}")
    print(f"Random Forest Regressor MAE: {mae:.2f}")
    print(f"Random Forest Regressor MedAE: {medae:.2f}")
